        ...
        <div class="col-lg-12">
          ...
          <div id="carouselExampleIndicators" class="carousel slide my-4" data-ride="carousel">
            ...
            <div class="carousel-inner" role="listbox" style=" height=500px; width=1250px; ">
                ...
                <img class="d-block img-fluid" src="image/image1.jpg"  style="max-height: 500px; max-width;" alt="First slide">
              </div>
              <div class="carousel-item">
                <img class="d-block img-fluid" src="image/image2.jpg" style="max-height: 500px; max-width;" alt="Second slide">
              </div>
            </div>
