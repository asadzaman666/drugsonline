			...
			<form method="post" action="<?php echo e(route('order.store')); ?>" class="needs-validation" validate>
				...
				<div class="row">
					<div class="col-md-6 mb-3">
						...
						<input type="text" class="form-control" id="firstName" name="firstName" placeholder="Mohsin" <?php if(session()->has('user')): ?>
					...
					<div class="col-md-6 mb-3">
						...
						<input type="text" class="form-control" id="lastName" name="lastName" placeholder="Haider" <?php if(session()->has('user')): ?>
				...
				<div class="mb-3">
					...
					<input type="text" class="form-control" id="phone" name="phone" placeholder="123456789" <?php if(session()->has('user')): ?>
				...
				<div class="mb-3">
					...
					<input type="email" class="form-control" id="email" name="email" placeholder="you@example.com" <?php if(session()->has('user')): ?>
				...
				<div class="mb-3">
					<label for="address">Shipping address <span class="text-muted">(Different delivery address? Type here)</span>
					</label>
					<input type="text" class="form-control" name="address" id="address" placeholder="eg. Plot 22, Block c, Bashundhara, Dhaka 1229"
					 <?php if(session()->has('user')): ?>
