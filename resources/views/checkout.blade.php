			...
			<form method="post" action="{{route('order.store')}}" class="needs-validation" validate>
				...
				<div class="row">
					<div class="col-md-6 mb-3">
						...
						<input type="text" class="form-control" id="firstName" name="firstName" placeholder="Mohsin" @if(session()->has('user'))
					...
					<div class="col-md-6 mb-3">
						...
						<input type="text" class="form-control" id="lastName" name="lastName" placeholder="Haider" @if(session()->has('user'))
				...
				<div class="mb-3">
					...
					<input type="text" class="form-control" id="phone" name="phone" placeholder="123456789" @if(session()->has('user'))
				...
				<div class="mb-3">
					...
					<input type="email" class="form-control" id="email" name="email" placeholder="you@example.com" @if(session()->has('user'))
